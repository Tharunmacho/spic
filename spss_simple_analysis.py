...
print("\n[SAVED] Graph: Program1_SPSS_Analysis.png")
plt.close()
...
print("\n[SAVED] Graph: Program2_SPSS_Analysis.png")
plt.close()
...
print("\n[SAVED] Graph: Program3_SPSS_Analysis.png")
plt.close()
...
print("\n[SAVED] Graph: Program4_SPSS_Analysis.png")
plt.close()
...
print("\n[SAVED] Graph: All_Programs_Summary.png")
plt.close()
...
print("="*80)
print("  [OK] Descriptive Statistics (Mean, Std Dev, Min, Max, Quartiles)")
print("  [OK] Group Statistics with Standard Error")
print("  [OK] ANOVA F-test for equality of means")
print("  [OK] Independent Samples T-Test (95% Confidence Intervals)")
print("  [OK] Box Plots (showing median, quartiles, outliers)")
print("  [OK] Violin Plots (showing distribution shape)")
print("  [OK] Error Bar Charts (95% CI on means)")
print("  [OK] Line plots (fold-by-fold performance)")
